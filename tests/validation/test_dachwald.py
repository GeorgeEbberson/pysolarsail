...
from tests.common_test_utils import KERNELS_DIR, VALIDATION_TEST_DIR, TestCase

# Files needed for Dachwald's Mercury Rendezvous
DACHWALD_MERCURY_KERNELS = ("mercury_rendezvous.bsp", "naif0012.tls", "pck00010.tpc", "gm_de431.tpc")
DACHWALD_MERCURY_ALPHA_FILE = VALIDATION_TEST_DIR / "data" / "dachwald_mercury_alpha.csv"
DACHWALD_MERCURY_BETA_FILE = VALIDATION_TEST_DIR / "data" / "dachwald_mercury_beta.csv"
...
class TestDachwald(TestCase):
    ...
    def test_dachwald_mercury(self):
        ...
        if self.SHOULD_PLOT:
            self.plot_mercury_results(results)
    ...
    @staticmethod
    def plot_mercury_results(results):
        """Plot the results of the transfer to Mercury."""
